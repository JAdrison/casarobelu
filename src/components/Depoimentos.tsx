...
export const Depoimentos = () => (
  <section className="bg-champagne py-28 md:py-40 px-6">
    <div className="max-w-7xl mx-auto">
      <div className="text-center mb-20">
        <p className="reveal eyebrow mb-6">Hóspedes</p>
        <h2 className="reveal reveal-delay-1 font-display text-4xl md:text-5xl text-dark-text italic">
          Quem chega, volta.
        </h2>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 md:gap-8">
        {items.map((t, i) => (
          <figure
            key={t.name}
            className={`reveal reveal-delay-${i + 1} relative bg-off-white p-10 md:p-12 border-t-2 border-terracota/30`}
          >
            <span
              aria-hidden
            ...
            <blockquote className="relative font-serif-italic italic text-lg md:text-xl text-dark-text leading-relaxed">
              {t.text}
            </blockquote>
